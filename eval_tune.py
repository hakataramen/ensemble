...
"{'decisiontreeclassifier': DecisionTreeClassifier(class_weight=None,
    criterion='entropy', max_depth=1, max_feature=None, max_leaf_nodes=None,
 ...
 'pipeline-1':Pipeline(steps=[('sc', StandardScalar(copy=True, with_mean=True,
                       ...
                       penalty='12', random_state=0, solver='liblinear', tol=0.0001, verbose=0))])
 ...
 'pipeline-2':Pipeline(steps=[('sc', StandardScalar(copy=True, with_mean=True,
 ...
 'pipeline-2__clf__algorythm': 'auto',
